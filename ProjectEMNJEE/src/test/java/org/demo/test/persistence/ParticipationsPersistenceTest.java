...
public class ParticipationsPersistenceTest 
{
	...
	private void process(ParticipationsPersistence service, ParticipationsEntityMock mock, Integer id, String email ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		ParticipationsEntity entity = service.load( id, email );
		if ( entity != null ) {
			// Found 
			...
			entity = mock.createInstance( id, email ) ;
			...
			*/
			...
			boolean deleted = service.delete( id, email );
